<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        $nim = $_SESSION['NIM'];
        mysqli_query($conn, "INSERT INTO post (NIM, Message, Type, Content) VALUES ('$nim', '$catatan', 2, '$catatan')");
        ...
        <section>
            ...
            <div class="kotak">
                ...
                <div class='grup-input'>
                    <textarea rows='10' cols='30' name='catatan' id='catatan' placeholder='Apa yang kamu pikirkan?' style="width: 80%;"></textarea>
                    <div class="error-msg" id="error-catatan"></div>
                </div>
                <div class='grup-input'>
                <button name='folder_button' id='folder_button' type="submit"><i class='fas fa-pencil-alt'></i> Buat Postingan</button>
